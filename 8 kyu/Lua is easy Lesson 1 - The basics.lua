...
-- 
-- Lua is a dynamically-typed language, and it has eight basic types: 
...
-- 
-- Strings have many methods which we will cover in Lesson 4: Strings. For this Kata, we need to know 
-- that string concatenation is performed using two dots:
-- 
...
-- 
-- You will write a simple function that takes 3 inputs a, b, c and returns a concatenated with 
-- a * b concatenated with 'Lua' if b >= c otherwise "Codewars". Seperate them with one space.
-- 
-- For example:
-- 
...
function kata.firstLua(a,b,c)
  local part2 = a * b
  local part3 = (b >= c) and "Lua" or "Codewars"
  return a .. " " .. part2 .. " " .. part3
end
